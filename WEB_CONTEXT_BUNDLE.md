...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0105-questions-in-geometric-group-theory-q-a96a0e31",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0105-00a64a4cc9bb",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0105"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Davis) If $G$ is word-hyperbolic, does the Rips complex $P_d(G)$ have an equivariant negatively curved metric for $d$ sufficiently large?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 1.5",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "f88bba4f5fb43f0e01932d69c468dbe3e1fedffec254d9aafcf4dadac81489a6"
}
```
